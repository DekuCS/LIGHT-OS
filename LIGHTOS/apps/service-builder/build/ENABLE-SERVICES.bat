...
reg.exe add "HKLM\%HIVE%\Services\acpipagr" /v "Start" /t REG_DWORD /d "1" /f
...
reg.exe add "HKLM\%HIVE%\Services\cbdhsvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\Dhcp" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\EABackgroundService" /v "Start" /t REG_DWORD /d "3" /f
reg.exe add "HKLM\%HIVE%\Services\Eaphost" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\EasyAntiCheat" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\LGHUBUpdaterService" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\NdisVirtualBus" /v "Start" /t REG_DWORD /d "1" /f
...
reg.exe add "HKLM\%HIVE%\Services\Netman" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\netprofm" /v "Start" /t REG_DWORD /d "4" /f
reg.exe add "HKLM\%HIVE%\Services\NetSetupSvc" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\NlaSvc" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\PcaSvc" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\StateRepository" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\TabletInputService" /v "Start" /t REG_DWORD /d "3" /f
...
reg.exe add "HKLM\%HIVE%\Services\Telemetry" /v "Start" /t REG_DWORD /d "0" /f
...
reg.exe add "HKLM\%HIVE%\Services\UdkUserSvc" /v "Start" /t REG_DWORD /d "2" /f
...
reg.exe add "HKLM\%HIVE%\Services\Wcmsvc" /v "Start" /t REG_DWORD /d "4" /f
...
reg.exe add "HKLM\%HIVE%\Services\WlanSvc" /v "Start" /t REG_DWORD /d "4" /f
