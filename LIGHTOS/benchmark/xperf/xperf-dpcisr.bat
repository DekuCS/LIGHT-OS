...
xperf -stop > nul 2>&1
xperf -quiet -i "C:\LIGHTOS\benchmark\xperf\captures\kernel.etl" -o "C:\LIGHTOS\benchmark\xperf\captures\report.txt" -a dpcisr
echo info: report saved in C:\LIGHTOS\benchmark\xperf\captures\
